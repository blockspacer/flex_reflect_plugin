...
add_library( ${gtest_test_runner} OBJECT
  ${CMAKE_CURRENT_SOURCE_DIR}/../flex_reflect/test/run_all_unittests.cc
)
...
target_compile_definitions( ${gtest_test_runner} PUBLIC
  BUILD_DATE=FLEX_REFLECT_BUILD_DATE
  USE_GTEST_TEST=1 )

macro(flex_reflect_test_gtest test_name source_list)
  ...
  flex_reflect_test("${test_name}" "${source_list}" "${GTEST_TEST_ARGS}" "${gtest_test_runner}")
endmacro()
