...
class flex_reflect_plugin_conan_project(conan_build_helper.CMakePackage):
    ...
    def _configure_cmake(self):
        ...
        if self.options.shared:
          self.output.info('Enabled flex_reflect_plugin_BUILD_SHARED_LIBS')
          cmake.definitions["flex_reflect_plugin_BUILD_SHARED_LIBS"] = "ON"
        else:
          self.output.error('Disabled flex_reflect_plugin_BUILD_SHARED_LIBS')
    ...
    def package_info(self):
        #self.cpp_info.libs = ["flex_reflect_plugin"]
        ...
        self.env_info.flex_reflect_plugin_ROOT = self.package_folder
        #flex_reflect_plugin = "flex_reflect_plugin.dll" if self.settings.os_build == "Windows" else "flex_reflect_plugin.so"
        #self.env_info.flex_reflect_plugin_LIB = os.path.normpath(os.path.join(self.package_folder, "lib", flex_reflect_plugin))

        #self.cpp_info.includedirs.append(os.getcwd())
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "flex_reflect_plugin"))
        #self.cpp_info.includedirs.append(
        #  os.path.join("base", "third_party", "flex_reflect_plugin", "compat"))
